...
<div class="main">
    <form action="Cslt_Collabo.php" method="get" id="frm1">
        ...
        <?php while($xtr=$dr_affiche->fetch()){?>
            ...
            <td class="action"><a href="supp_Collaborateur.php?matricule=<?php echo($xtr['matricule']); ?>" onclick="return confirm('veuillez vraiment suprimer <?php echo($xtr['nom']); ?>');" value="<?php echo($xtr['matricule']); ?>" class="td_button_delete">Delete</a> | <a href="" class="td_button_update" value="<?php echo($xtr['matricule']); ?>">Update</a></td></tr>
